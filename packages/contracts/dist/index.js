...
export const object = (properties) => Type.Object(properties, { additionalProperties: false });
...
export const Generation = object({
    ...
    createdAt: Type.String({ format: 'date-time' }),
    imageUrl: Type.Unsafe({ type: 'string', nullable: true }),
    failureCode: Type.Unsafe({ type: 'string', nullable: true }),
    links: Links,
});
